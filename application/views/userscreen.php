...
<html>
    <head>
        <title><?php echo $uname; ?> Home</title>
        <link rel="icon" href="<?php echo base_url(); ?>images/icon.jpg">
    ...
    <body style="font-family:'Merriweather',serif;">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
            <!-- WEBSITE NAME  -->
            <a class="navbar-brand" href="home"><i class="fas fa-tasks"></i> ToDoList</a>
            ...
            <div class="collapse navbar-collapse" id="links">
                <ul class="navbar-nav">
                  <li class="nav-item active dropdown">
                  	<a class="nav-link dropdown-toggle-no-caret" data-toggle="dropdown" data-target="#userMenu" href=""><i class="fas fa-user"></i> <?php echo $uname; ?></a>
        ...
        <!-- ADD BUTTON -->
        <div class="dropup" id="float">
            <button type="button" class="btn btn-dark dropdown-toggle-no-caret" id="float-btn" data-toggle="dropdown"><i class="fa fa-plus"></i></button>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="addtask" method="post">
                        ...
                        <div class="form-group">
                          <label for="tdesc">Description:</label><textarea class="form-control" rows="5" name="tdesc"></textarea>
                        </div>
                        ...
                        <div class="input-group-prepend">
                          ...
                          <input id="cdate" class="form-control" name="cdate" value="<?php echo date('Y-m-d'); ?>" disabled>
                ...
                <div id="accordion">
                    <div class="card text-center">
                        <div class="card-header" style="background-color:lightgray;">
                          <a class="card-link my-grid" style="text-decoration:none;color:#404040" data-toggle="collapse" href='<?php echo "#data".$i; ?>'>
                            <div class="itemName"><?php echo $row['tname']; ?></div>
                            <div class="itemLocation"><i class="fas fa-map-marker-alt"></i> <?php echo $row['tloc']; ?></div>
                          </a>
                        </div>
